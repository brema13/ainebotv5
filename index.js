...
client.on('group-participants-update', async (anu) => {
	...
	client.on('message-new', async (mek) => {
		...
		case 'quotesislami':
					...
					client.sendMessage(from, islam, image, { quoted: mek, caption: '*Quotes Kehidupan*\n\n'+ isl })
					await limitAdd(sender)
					break	
		case 'quotesnasehat':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, nase, image, { quoted: mek, caption: '*Quotes Kehidupan*\n\n'+ nsh })
					await limitAdd(sender)
					break	
		case 'quotescinta':
					if (!isRegistered) return reply(ind.noregis())
					...
					client.sendMessage(from, cta, image, { quoted: mek, caption: '*Quotes Kehidupan*\n\n'+ cin })
					await limitAdd(sender)
					break	
		case 'ssweb':
					if (!isRegistered) return reply(ind.noregis())
